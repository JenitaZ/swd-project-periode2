/*
*
* zorgt voor de slideshows voor game reviews: 2, 3 en 4 
* 
*
*/
...
if (params.includes("0")){
    value = true;
}else if (params.includes("TR")){           /* Als de website link ergens "TR" heeft, value = "Terraria" etc. */
    value = "Terraria";
...
} else if (value == "BOKURA"){      /* De prompt foto aan einde(een-na-laatste) slide */
...
/* --------- Zorgt ervoor dat de knoppen werken ----------- */
