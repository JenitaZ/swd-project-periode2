/*
*
* Slideshows for reviews: 2, 3 en 4 
* 
*
*/
...
if(value === true) {
    ...
    //let's user choose between showing cat or penguin at (one before) end of slide
...
function changeGameImg() {
    ...
    // Wraps the currentIndex around to the beginning of the array when it reaches end.
    currentIndex = (currentIndex + 1) % currentGame.image.length;
    reviewImg.src = currentGame.image[currentIndex];
    transform

    // Hides last "img", shows the video instead
