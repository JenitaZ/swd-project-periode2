...
const imgLeft = document.getElementById("reviewImgL");
const imgCenter = document.getElementById("reviewImgC");
const imgRight = document.getElementById("reviewImgR");
let pegi;
...
const gameInfo = {
    game0: {
        ...
        image: {
            ...
            img2:"https://i.pcmag.com/imagery/reviews/07ixBkx8aMYYMNiJEMvCNq4-1..v1666484268.jpg",
            img3: "https://miro.medium.com/v2/resize:fit:1400/1*l1AMsvG2A6vJhgNVprYeFQ.jpeg",
            img4: "https://i.ytimg.com/vi/mz0g9hxq7L8/maxresdefault.jpg"
        },
        alt: "Persona5",
    ...
    game1: {
        ...
        image: {
            ...
            img2:"https://store-images.s-microsoft.com/image/apps.2573.14365677083355647.b1865964-f828-4b4e-882a-b2b76753c30f.fbf9cdd8-8fa5-4701-8423-b16268363eff?q=90&w=480&h=270",
            img3: "https://store.ubisoft.com/dw/image/v2/ABBS_PRD/on/demandware.static/-/Sites-masterCatalog/default/dwe51edac0/images/large/62ea4f8e09372571f2736a71-9.jpg?sw=500&sh=270&sm=fit",
            img4: "https://i.ytimg.com/vi/xJexCqgG3Js/maxresdefault.jpg"
        },
...
if (value === true) {
    ...
    imgCenter.src = gameInfo.game0.image.img2;
    imgLeft.src = gameInfo.game0.image.img3;
    imgRight.src = gameInfo.game0.image.img4;
    ...
    imgCenter.src = gameInfo.game1.image.img3;
    imgLeft.src = gameInfo.game1.image.img2;
    imgRight.src = gameInfo.game1.image.img4;
