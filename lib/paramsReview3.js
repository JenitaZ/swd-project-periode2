...
if (params.includes("ITT")){
    value = "ITT";
}else if (params.includes("NR")){
   value = "NR";
}else {
    value = "STA";
}
const gameInfo = {
    ...
    ITT: {
        title: "Bread & Fred",
        release_date: "May 23rd, 2023",
        platforms: "Xbox series X/S, PS4/5, PC, Switch",
        description: "Bread & Fred is a challenging co-op platformer from Apogee where two players must cooperate to jump and climb to the top of a snowy mountain.",
        image: [
            "https://www.nintendo.com/eu/media/images/10_share_images/games_15/nintendo_switch_download_software_1/2x1_NSwitchDS_BreadAndFred_image1600w.jpg",
            "https://www.sandcastlesst.com/img/webp/screenshots/BF_Screenshot_8.webp",
            "https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/1607680/ss_3bb49c5df52c537b9065a297ee0af5364db3ca39.1920x1080.jpg?t=1734461970",
            "https://www.cdkeynl.nl/wp-content/uploads/bread-and-fred-800x500-3.jpg",
            "https://www.youtube.com/embed/MM09k_NgkeA?si=DKrmt1kwr1QexXe9"
        ],
        alt: "Bread & Fred",
        gameDesc: "<span id='title'>Bread & Fred</span> <br> <span id='smallGrayText'>released on: March 25th, 2021, developed by: SandCastles Studio and published by  Atari, Infogrames </span> <br><br>Bread & Fred is a challenging co-op platformer from Apogee where two players must cooperate to jump and climb to the top of a snowy mountain. <br><br>Play as both Bread and Fred in their exasperating, sometimes maddening, climb that requires precision with every jump. Each time you land you’ll be closer to the peak and one step closer to mastering the platforms, but your fall down the mountain will be even farther.",
        genre: "", 
    }
}
...
switch (value) {
    ...
    case "ITT":{
        ...
        let reviewImg = document.getElementById('reviewImg'); 
        let currentIndex = 0;
        reviewImg.src = gameInfo.ITT.image[0];

        pegi = 16;
        age = prompt("confirm your age:");

        if(age >= pegi){
            title.innerText = gameInfo.ITT.title;
            rD.innerText = gameInfo.ITT.release_date;
            platforms.innerText = gameInfo.ITT.platforms;
            desc.innerText = gameInfo.ITT.description;
            reviewImg.alt = gameInfo.ITT.alt;
         
    
            reviewText.innerHTML = gameInfo.ITT.gameDesc;
        ...
        // gaat naar de volgende afbeelding
        function changeGameImg() {
            currentIndex = (currentIndex + 1) % gameInfo.ITT.image.length;
            reviewImg.src = gameInfo.ITT.image[currentIndex];
            console.log(gameInfo.ITT.image[currentIndex]);
            
            if (currentIndex == gameInfo.ITT.image.length - 1){
                reviewVid.src = gameInfo.ITT.image[currentIndex];
                reviewImg.src = ""
                reviewImg.style.display = "none";
                reviewVid.style.display = "inline";
        ...
        /* gaat naar de vorige afbeelding */
        function changeGameImgL() {
            currentIndex = (currentIndex - 1 + gameInfo.ITT.image.length) % gameInfo.ITT.image.length;
            reviewImg.src = gameInfo.ITT.image[currentIndex];
            console.log(gameInfo.ITT.image[currentIndex]);
