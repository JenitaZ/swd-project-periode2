...
if (value === true) {
    ...
    // imgCenter.src = gameInfo.game0.image[1];
    // imgLeft.src = gameInfo.game0.image[2];
    // imgRight.src = gameInfo.game0.image[3];
// probs gonna become- recommended games
    ...
    // imgCenter.src = gameInfo.game1.image[1];
    // imgLeft.src = gameInfo.game1.image[2];
    // imgRight.src = gameInfo.game1.image[3];
