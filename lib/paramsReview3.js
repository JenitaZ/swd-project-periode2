...
switch (value) {
    ...
    case false:
        let currentIndex2 = 0;
        let reviewVid2 = document.getElementById('reviewVid');
        ...
        function changeGameImgN() {
            ...
            if (currentIndex2 == gameInfo.game1.image.length - 1){
                reviewVid2.src = gameInfo.game1.image[currentIndex2];
                reviewImg2.src = ""
                reviewImg2.style.display = "none";
                reviewVid2.style.display = "inline";
        
            }else {
                reviewVid2.src = "";
                reviewVid2.style.display = "none";
                reviewImg2.style.display = "inline";
            }
        }
